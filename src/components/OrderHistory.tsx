...
import { X, Package, Clock, CheckCircle, User, ArrowLeft } from 'lucide-react';
...
const OrderHistory: React.FC<OrderHistoryProps> = ({ isOpen, onClose }) => {
  ...
  const OrderCard = ({ order }: { order: OrderWithItems }) => (
    <motion.div
      ...
      className="border border-gray-200 rounded-xl p-4 cursor-pointer hover:bg-gray-50/70 hover:shadow-sm transition-all"
    >
      ...
      <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-200">
        ...
        <span className="text-sm font-medium text-green-600 hidden sm:inline">View Details →</span>
      </div>
